...
# HTML Content:
# 1. Stats Cards: col-lg-6 -> col-6 (Force single row)
# 2. Charts: Polar -> Horizontal Bar (Cleaner)
# 3. Layout: Ensure Filters are compact
...
<div class="container-fluid py-4">
    ...
    <!-- Charts Row: Now using Horizontal Bars for clearer reading -->
    <div class="row mb-4">
        <div class="col-md-6">
            <div class="card bg-dark text-white shadow h-100">
