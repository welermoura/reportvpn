...
# HTML Content:
# 1. Stats Cards: SIDE-BY-SIDE (maintained)
# 2. Charts: FORCE SIDE-BY-SIDE using d-flex (same logic as Cards)
...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between mb-4" style="gap: 1rem;">
        <div class="card bg-dark text-white shadow" style="flex: 1;">
    ...
    <!-- Charts Section: FORCE SIDE-BY-SIDE -->
    <div class="d-flex justify-content-between mb-4" style="gap: 1rem;">
        <div class="card bg-dark text-white shadow" style="flex: 1; min-width: 0;"> <!-- min-width:0 handles flex overflow issues -->
        ...
        <div class="card bg-dark text-white shadow" style="flex: 1; min-width: 0;">
    ...
    <div class="card bg-dark text-white shadow">
        ...
        <div class="card-header border-bottom-secondary p-3">
            <form method="get" class="row g-2 align-items-center">
                ...
                <div class="col-md-auto fw-bold text-uppercase small me-2">
