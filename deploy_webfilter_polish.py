...
# HTML Content:
# Refined User Column:
# - If Display Name exists: Show Name (Bold) + Username (Small/Grey)
# - If NO Display Name: Show Username (Bold)
                ...
                <table class="table table-dark table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- USER COLUMN: Optimized Visual Hierarchy -->
                                <div class="d-flex flex-column">
                                    {% if event.ad_display_name %}
                                        <span class="fw-bold text-white fs-6">{{ event.ad_display_name }}</span>
                                        <span class="small text-white-50">{{ event.username }}</span>
                                    {% else %}
                                        <span class="fw-bold text-white fs-6">{{ event.username|default:"-" }}</span>
                                    {% endif %}
                                </div>
                            </td>
                            <td>
