...
# HTML Content:
# 1. Stats Cards: CSS GRID (2 columns) - Confirmed working
# 2. Charts: CSS GRID (2 columns) - Confirmed working
# 3. Filters: FLEX ROW - Confirmed working
# 4. URLs: CLICKABLE LINKS - New request
                        ...
                        <tr class="border-bottom border-secondary">
                            ...
                            <td title="{{ event.url }}">
                                <div style="max-width: 250px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                    <a href="{% if 'http' not in event.url %}http://{% endif %}{{ event.url }}" target="_blank" rel="noopener noreferrer" class="text-info text-decoration-none hover-underline">
