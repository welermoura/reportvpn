...
# HTML Content with CLICKABLE CHART BARS
# When user clicks on a bar in either chart, it will apply the corresponding filter
                ...
                options: {
                    ...
                    onClick: (event, activeElements) => {
                        if (activeElements.length > 0) {
                            ...
                            // Redirect to same page with URL filter
                            const currentUrl = new URL(window.location.href);
