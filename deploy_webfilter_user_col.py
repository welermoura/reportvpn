...
# HTML Content with USER COLUMN FIX + Syntax Fix
                            ...
                            <td>
                                ...
                                <div class="d-flex flex-column">
                                    {% if event.ad_display_name %}
                                        <span class="fw-bold">{{ event.ad_display_name }}</span>
                                        <span class="small text-muted">{{ event.username }}</span>
                                    {% else %}
                                        <span class="fw-bold">{{ event.username|default:"N/A" }}</span>
                                    {% endif %}
                                    
                                    {% if event.ad_title %}
                                        <span class="small text-info mt-1"><i class="fas fa-id-badge me-1"></i> {{ event.ad_title }}</span>
                                    {% endif %}
                                </div>
                            </td>
                            <td>
